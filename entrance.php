...
<div id="wrapper">
	<div id="content">
		...
		<!--Основная часть сайта-->
		 <?php require_once "bloks/modulReg.php"; ?>
		<div id="reginfo">
			<span>ВХОД</span>
			<div id="err"></div>
            <div class="reg">
				<input class="poleText" type="text" id="email" placeholder="E-mail" onclick="$(this).css('border-color', '#007a96')" /><br />
				<input class="poleText" type="password" id="pwd" placeholder="Пароль" onclick="$(this).css('border-color', '#007a96')" /><br />
				<button id="regData">Войти</button><br />
			</div>
        </div>
