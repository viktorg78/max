...
require_once $_SERVER['DOCUMENT_ROOT']."/service_information/cooki.php";
    ...
    $arenda = $message2[0]['arenda'];
    $zalog = $message2[0]['zalog'];
    $ysluga = $message2[0]['ysluga'];
...
<div id="wrapper">
	<div id="content">
		...
		<div class="obl2">
		<form action="announcement3_edit_arend.php" method="post" id="my_form" enctype="multipart/form-data">
		<table class="tabl2">
		...
		<tr><td class="td2">Город в котором вы находитесь</td><td class="td3">
			...
			<!-- ================================== -->
			<tr><td class="td2">Производитель<span>*</span></td><td class="td3"><input class="poleText" type="text" name="proizvod" id="proizvod" value="<?php echo $proizv; ?>" onclick="$(this).css('border-color', '#007a96')"></td></tr>
			<tr><td class="td2">Модeль<span>*</span></td><td class="td3"><input class="poleText" type="text" name="model" id="model" value="<?php echo $model; ?>" onclick="$(this).css('border-color', '#007a96')"></td></tr>
...
<!-- ============================================================================== -->
            <tr><td class="td2">Долгоскрочная аренда или краткосрочная аренда</td><td class="td3">
				<?php
                switch($arenda)
                {
                    case 1:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check1\" type=\"checkbox\" name=\"k_arend\" checked=\"checked\">"; 
				        echo "<label for=\"check1\" class=\"lab2\">Краткосрочная</label>";
				        echo "</div>";
				        echo "<div class=\"checkbox\">";
				        echo "<input id=\"check2\" type=\"checkbox\" name=\"d_arend\">"; 
				        echo "<label for=\"check2\" class=\"lab2\">Долгасрочная</label>";
                        echo "</div>"; 
                        break;
                    case 2:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check1\" type=\"checkbox\" name=\"k_arend\">"; 
				        echo "<label for=\"check1\" class=\"lab2\">Краткосрочная</label>";
				        echo "</div>";
				        echo "<div class=\"checkbox\">";
				        echo "<input id=\"check2\" type=\"checkbox\" name=\"d_arend\" checked=\"checked\">"; 
				        echo "<label for=\"check2\" class=\"lab2\">Долгасрочная</label>";
                        echo "</div>"; 
                        break; 
                    case 3:
			...
			<tr><td class="td2">Залог</td><td class="td3">
                <?php
                switch($zalog){
                    case 1:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check3\" type=\"checkbox\" name=\"da_zalog\" checked=\"checked\">"; 
                        echo "<label for=\"check3\" class=\"lab2\">Да</label>";
                        echo "</div>";
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check4\" type=\"checkbox\" name=\"net_zalog\">"; 
                        echo "<label for=\"check4\" class=\"lab2\">Нет</label>";
                        echo "</div>";
                        break;
                    case 2:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check3\" type=\"checkbox\" name=\"da_zalog\">"; 
                        echo "<label for=\"check3\" class=\"lab2\">Да</label>";
                        echo "</div>";
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check4\" type=\"checkbox\" name=\"net_zalog\" checked=\"checked\">"; 
                        echo "<label for=\"check4\" class=\"lab2\">Нет</label>";
                        echo "</div>";
                        break;
                    case 3:
			...
			<tr><td class="td2">Услуги водителя/ машиниста/ рабочего персонала</td><td class="td3">
                <?php
                switch ($ysluga){
                    case 1:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check5\" type=\"checkbox\" name=\"da_yslygi\" checked=\"checked\">"; 
                        echo "<label for=\"check5\" class=\"lab2\">Да</label>";
                        echo "</div>";
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check6\" type=\"checkbox\" name=\"net_yslygi\">"; 
                        echo "<label for=\"check6\" class=\"lab2\">Нет</label>";
                        echo "</div>";
                        break;
                    case 2:
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check5\" type=\"checkbox\" name=\"da_yslygi\">"; 
                        echo "<label for=\"check5\" class=\"lab2\">Да</label>";
                        echo "</div>";
                        echo "<div class=\"checkbox\">";
                        echo "<input id=\"check6\" type=\"checkbox\" name=\"net_yslygi\" checked=\"checked\">"; 
                        echo "<label for=\"check6\" class=\"lab2\">Нет</label>";
                        echo "</div>";
                        break;
                    case 3:
