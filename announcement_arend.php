...
<div id="wrapper">
	<div id="content">
		...
		<div class="obl2">
		<form action="announcement3_arend.php" method="post" id="my_form" enctype="multipart/form-data">
		<table class="tabl2">
		...
		<tr><td class="td2">Город в котором вы находитесь</td><td class="td3">
			...
			<tr><td class="td2">Стоимость аренды</td><td class="td3"><input class="poleText" type="text" name="cesh"></td></tr>
			...
			<tr><td class="td2">Долгоскрочная аренда или краткосрочная аренда</td><td class="td3">
				<div class="checkbox">
					<input id="check1" type="checkbox" name="k_arend"> 
					<label for="check1" class="lab2">Краткосрочная</label>
				</div>
				<div class="checkbox">
					<input id="check2" type="checkbox" name="d_arend"> 
					<label for="check2" class="lab2">Долгасрочная</label>
				</div>	
			</td></tr>

			<tr><td class="td2">Залог</td><td class="td3">
				<div class="checkbox">
					<input id="check3" type="checkbox" name="da_zalog"> 
					<label for="check3" class="lab2">Да</label>
				</div>
				<div class="checkbox">
					<input id="check4" type="checkbox" name="net_zalog"> 
					<label for="check4" class="lab2">Нет</label>
				</div>	
			</td></tr>

			<tr><td class="td2">Услуги водителя/ машиниста/ рабочего персонала</td><td class="td3">
				<div class="checkbox">
					<input id="check5" type="checkbox" name="da_yslygi"> 
					<label for="check5" class="lab2">Да</label>
				</div>
				<div class="checkbox">
					<input id="check6" type="checkbox" name="net_yslygi"> 
					<label for="check6" class="lab2">Нет</label>
				</div>	
			</td></tr>
