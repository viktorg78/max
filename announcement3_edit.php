...
//	$imj2=addslashes(file_get_contents($_FILES['myfile'][1]['tmp_name']));
	...
	if ($_FILES["myfile5"]["name"]==NULL){ // нету файла
		...
		setFoto($id_f, $id_logo, 5, $imj6);//грузим фото в базу
	}
	...
	getMes($id_f, $id_logo, $kontrogent, $name1, $name2, $name3, $name4, $site, $typTeh, $proizvod, $model, $opis, $cesh, $otvet, $telk, $telk_skr, $oplata, $typTeh2);
